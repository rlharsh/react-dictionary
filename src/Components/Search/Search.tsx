...
const Search = () => {
  ...
  const themeClass = theme === 'dark' ? 'search__input search__input__dark' : 'search__input search__input__light';
  ...
  const renderError = () => {
    ...
    return (
      <div><p className='error-text'>Whoops, can't be empty…</p></div>
    )
  };
  ...
  return (
    <div className='search'>
      <form onSubmit={handleSubmit}>
        <input type="text" name="search" id="search" className={themeClass} placeholder='Search for any word...' />
